...
COMPANY_EMAIL = os.getenv("COMPANY_EMAIL", "hr@yourcompany.com")

# ---------------- EMAIL RECEIVING (Method 1: IMAP Polling) ----------------
IMAP_HOST = os.getenv("IMAP_HOST", "imap.gmail.com")
IMAP_PORT = int(os.getenv("IMAP_PORT", "993"))
IMAP_EMAIL = os.getenv("IMAP_EMAIL", "")          # company email jahan CVs aati hain
IMAP_APP_PASSWORD = os.getenv("IMAP_APP_PASSWORD", "")  # Gmail App Password
...
SMTP_EMAIL = os.getenv("SMTP_EMAIL", "")          # from email address
